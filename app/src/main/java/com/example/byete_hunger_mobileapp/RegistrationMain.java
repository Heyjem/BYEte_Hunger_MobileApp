...
public class RegistrationMain extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Continue = findViewById(R.id.button3_Registration_Continue);
        ...
        Continue.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (text.equals("Organization")) {
                    startActivity(new Intent(RegistrationMain.this, OrgRegistration.class));
                }else if(text.equals("Individual")){
                    startActivity(new Intent(RegistrationMain.this, IndivRegistration.class));
                }
            }
        });
    }
